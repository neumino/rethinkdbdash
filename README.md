...
- `servers`: an array of objects `{host: <string>, port: <number>}` representing instances of Rethink deployments. Alternatively, you can pass these options without the `server {...}` if you are using only one connection.
