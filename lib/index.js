...
r.prototype.monday = function() { return new Term().monday() };
r.prototype.tuesday = function() { return new Term().tuesday() };
r.prototype.wednesday = function() { return new Term().wednesday() };
r.prototype.thursday = function() { return new Term().thursday() };
r.prototype.friday = function() { return new Term().friday() };
r.prototype.saturday = function() { return new Term().saturday() };
r.prototype.sunday = function() { return new Term().sunday() };

r.prototype.january = function() { return new Term().january() };
r.prototype.february = function() { return new Term().february() };
r.prototype.march = function() { return new Term().march() };
r.prototype.april = function() { return new Term().april() };
r.prototype.may = function() { return new Term().may() };
r.prototype.june = function() { return new Term().june() };
r.prototype.july = function() { return new Term().july() };
r.prototype.august = function() { return new Term().august() };
r.prototype.september = function() { return new Term().september() };
r.prototype.october = function() { return new Term().october() };
r.prototype.november = function() { return new Term().november() };
r.prototype.december = function() { return new Term().december() };
