...
r.prototype.time = function(year, month, day, hour, minute, second, timezone) {
    return new Term().time(year, month, day, hour, minute, second, timezone);
}
r.prototype.epochTime = function(epoch_time) {
    return new Term().epochTime(epoch_time);
}
