...
r.prototype.setNestingLevel = function(nestingLevel) {
    r.prototype.nestingLevel = nestingLevel;
    Term.prototype._nestingLevel = r.prototype.nestingLevel;
}
...
r.prototype.createPool = function(options) {
    ...
    Term.prototype._r = this; // That's a little hack-ish, but it's faster than copying r or searching the query for r.
...
r.prototype.expr = function(expression, nestingLevel) {
    ...
    return new Term().expr(expression, nestingLevel);
};
...
r.prototype.exprJSON = function(json, nestingLevel) {
    ...
    nestingLevel = nestingLevel || this.nestingLevel;
    return new Term().exprJSON(json, nestingLevel);
}
