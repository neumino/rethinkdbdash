...
r.prototype.time = function() {
    if ((arguments.length !== 4) && (arguments.length !== 7)) throw new Error.ReqlDriverError("`r.time` called with "+arguments.length+" argument"+((arguments.length>1)?"s":""), this._query, "`r.time` takes 4 or 7 arguments");
