...
function Connection(r, options, resolve, reject) {
    ...
    options.host = options.host || r.host;
    options.port = options.port || r.port;
    options.authKey = options.authKey || r.authKey;
...
Connection.prototype._send = function(query, token, resolve, reject, originalQuery, noReply) {
    var self = this;
