...
function Pool(r, options) {
    ...
    //TODO: This logic should be moved in the master
...
Pool.prototype.putConnection = function(connection) {
    ...
    if (self._draining !== null) {
        ...
        // connection.close() will eventually emit `end`, and _decreaseNumConnections will be called
        // We call it now to compensate for latency as more connection may finish their query and return before this connection is closed.
...
Pool.prototype._expandBuffer = function() {
    if ((this._draining === null) &&
            (this._pool.getLength() < this.options.buffer) &&
            (this._numConnections < this.options.max)) {
        this.createConnection();
    }
}
