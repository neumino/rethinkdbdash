...
function Pool(r, options) {
    ...
    if (this.options.min > this.options.bufferSize) throw new Err.ReqlDriverError("You cannot set a buffer smaller than the number of connections")
...
Pool.prototype._decreaseNumConnections = function() {
    ...
    if(this._draining && this.getLength() === 0){
