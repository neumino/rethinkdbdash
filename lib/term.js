...
Term.prototype.monday = function() { return new Monday(this); };
Term.prototype.tuesday = function() { return new Tuesday(this); };
Term.prototype.wednesday = function() { return new Wednesday(this); };
Term.prototype.thursday = function() { return new Thursday(this); };
Term.prototype.friday = function() { return new Friday(this); };
Term.prototype.saturday = function() { return new Saturday(this); };
Term.prototype.sunday = function() { return new Sunday(this); };

Term.prototype.january = function() { return new January(this); };
Term.prototype.february = function() { return new February(this); };
Term.prototype.march = function() { return new March(this); };
Term.prototype.april = function() { return new April(this); };
Term.prototype.may = function() { return new May(this); };
Term.prototype.june = function() { return new June(this); };
Term.prototype.july = function() { return new July(this); };
Term.prototype.august = function() { return new Auguest(this); };
Term.prototype.september = function() { return new September(this); };
Term.prototype.october = function() { return new October(this); };
Term.prototype.november = function() { return new November(this); };
Term.prototype.december = function() { return new December(this); };
...
function TableList(db) {
    ...
    this.args = [];
    if (db !== undefined) this.args.push(new Term().expr(db))
