...
Term.prototype.distance = function(geometry, otherGeometry, options) {
  var self = this;
  ...
  if (options !== undefined) {
    args = [new Term(self._r).expr(geometry), new Term(self._r).expr(otherGeometry)];  
  } 
  else {
    args = [self, new Term(self._r).expr(geometry)];  
  }
