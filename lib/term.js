        ...
        var p = new Promise(function(resolve, reject) {
            ...
            helper.loopKeys(options, function(options, key) {
                if (keepGoing === true) {
                    ...
                    else if ((key !== "timeFormat") && (key !== "groupFormat") && (key !== "binaryFormat")) {
                        reject(new Error.ReqlDriverError("Unrecognized option `"+key+"` in `run`. Available options are useOutdated <bool>, durability <string>, noreply <bool>, timeFormat <string>, groupFormat: <string>, profile <bool>, binaryFormat <bool>"));
                        keepGoing = false;
                    }
                }
            });
                        ...
                        if (keepGoing === true) {
                            if ((key === "useOutdated") || (key === "durability") ||
                               (key === "noreply") || (key === "arrayLimit") || (key === "profile")) {
                                ...
                                setTimeout( function() {
                                    reject(new Error.ReqlDriverError("Unrecognized option `"+key+"` in `run`. Available options are useOutdated <bool>, durability <string>, noreply <bool>, timeFormat <string>, groupFormat: <string>, profile <bool>, binaryFormat: <string>"));
                                }, 0);
                                keepGoing = false;
                                return false;
                            }
