...
Term.prototype.distance = function(geometry, geometry2, options) {
  var self = this;

  self._noPrefix(self, 'distance');
  var term = new Term(self._r);
  term._query.push(termTypes.DISTANCE);
  var args = [new Term(self._r).expr(geometry), new Term(self._r).expr(geometry2)];
  term._fillArgs(args);
